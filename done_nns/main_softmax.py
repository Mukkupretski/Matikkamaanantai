...
def start_learning(labels, imgdata, alpha, iterations):
    ...
    for i in range(iterations):
        Z1, A1, Z2, A2 = forwardpropagation_softmax(imgdata, W1,B1,W2,B2)
        dW1, dB1, dW2, dB2 = backpropagation_softmax(labels, imgdata,W2,Z1,A1,Z2,A2)
...
def guess(imageData):
    _, _, _, A2 = forwardpropagation_softmax(imageData[:, np.newaxis], W1, B1, W2, B2)
    return A2.flatten()
def guessRandom():
